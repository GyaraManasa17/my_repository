...
def select_iso_9283_poses(csv_file_path):
    ...
    # 2. Find the bounding box of your collision-free workspace
    min_bounds = np.min(positions, axis=0)
    max_bounds = np.max(positions, axis=0)
    
    # 3. Define the ISO Test Cube
    # The standard recommends a cube inside the workspace. 
    # We find the center, and create a cube based on the smallest dimension to ensure it fits.
    ...
    # P1 is the center. P2-P5 are 10% inward from the corners of a diagonal plane.
    offset = L * 0.10 
    dist = half_L - offset
    ...
    print(f"\n✅ Saved the 5 ISO standard test configurations to: {output_file}")
    
    return selected_poses_df

if __name__ == "__main__":
    # REPLACE this with the actual name of the CSV file generated by your script
    # It should be located inside your fk_metrics folder
